  ...
  return (
    <main className="max-w-5xl mx-auto px-4 pt-24 pb-10">
      ...
      <h2 className="text-2xl md:text-3xl font-semibold text-center mt-8">
        A Conexão Certa para quem tem algo a ser transportado e claro, para
        todos os Motoristas.
      </h2>
      ...
      <p className="text-center mt-4">
        Seja qual for a sua categoria — Cliente/Embarcador, Motorista ou Afiliado, o cadastro é
        gratuito e o uso da plataforma é totalmente isento de mensalidade.
      </p>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        <a
          href="#cliente"
          className="rounded-2xl border p-5 py-4 min-h-[120px] text-center shadow-sm hover:shadow-md transition"
        >
      ...
      {/* Faixa divisória elegante antes da navegação */}
      <div className="mt-10">
        <div className="h-[1px] bg-gradient-to-r from-transparent via-black/10 to-transparent"></div>
        <div className="mt-2 h-1 bg-gradient-to-r from-indigo-200 via-indigo-400 to-indigo-200 rounded-full opacity-70"></div>
      </div>

      {/* Navegação em uma única linha, centralizada */}
      <nav
        aria-hidden="false"
